...
def setup_product():
    ...
    zcml.load_config('configure.zcml', Products.PFGMasterSelect)
    ...
    ztc.installPackage('Products.PFGMasterSelect')
...
setup_product()
ptc.setupPloneSite(products=['Products.PFGMasterSelect'])
